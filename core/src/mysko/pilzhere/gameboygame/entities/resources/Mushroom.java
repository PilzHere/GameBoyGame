 ...
 *
 */
public class Mushroom extends Resource implements Disposable {

	public Mushroom(GameScreen screen, float spawnPosX, float spawnPosY) {
		super(screen, spawnPosX, spawnPosY);

		createBody(spawnPosX, spawnPosY);

		super.texRegMain = new TextureRegion(AssetsManager.MANAGER.get(AssetsManager.ATLAS01, Texture.class), 75, 43,
				13, 11);
	...
	public void tick(float delta) {
		...
		super.spriteMain.setPosition(super.body.getTransform().getPosition().x - super.spriteMain.getRegionWidth() / 2,
				super.body.getTransform().getPosition().y + 1 - 0.99f - super.spriteMain.getRegionHeight() / 2);
	}
