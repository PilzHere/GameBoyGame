 ...
 *
 */
public class Iron extends Resource implements Disposable {
	
	public Iron(GameScreen screen, float spawnPosX, float spawnPosY) {
		super(screen, spawnPosX, spawnPosY);
		
		createBody(spawnPosX, spawnPosY);
		
		super.texRegMain = new TextureRegion(AssetsManager.MANAGER.get(AssetsManager.GUI, Texture.class), 19, 11, 6, 6);
