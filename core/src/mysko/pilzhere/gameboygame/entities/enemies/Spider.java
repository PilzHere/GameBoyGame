 ...
 *
 */
public class Spider extends Entity implements Disposable, RayCastCallback {
	...
	public Spider(GameScreen screen, float spawnPosX, float spawnPosY) {
		super.setScreen(screen);
		// super.id = screen.enemies.size;

		texRegIdleLeft = new TextureRegion(AssetsManager.MANAGER.get(AssetsManager.SPIDER, Texture.class), 1, 1, 24,
				12);
	...
	private void setupSpriteWalkingLeft(Texture tex) {
		TextureRegion texRegWalkingLeft1 = new TextureRegion(tex, 1, 1, 24, 12);
		TextureRegion texRegWalkingLeft2 = new TextureRegion(tex, 26, 1, 24, 12);
		TextureRegion texRegWalkingLeft3 = new TextureRegion(tex, 51, 1, 24, 12);
	...
	private final int moveSpeed = 70;
	...
	private final float spriteOffsetY = 1.99f;
	...
	public void render(float delta) {
		...
		super.bodyDimensions
				.set(new Vector3(18 + super.bBExtra / GameScreen.PPM, 8 + super.bBExtra / GameScreen.PPM, 0));
